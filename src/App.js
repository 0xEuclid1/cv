	...
	useEffect(() => {
		const getCurrencies = async () => {
			const api_call = await fetch(
				`https://evds2.tcmb.gov.tr/service/evds/series=TP.DK.USD.A&startDate=01-10-2017&endDate=07-08-2023&type=json&key=11C5kWDATU&frequency=3`
			);
					...
					<ul className="space-y-2">
						<li>
							<a
								...
								<a className="link-card inline-flex items-center gap-2 p-2" href="/">
									<img
									...
									<div className="flex flex-col">
										...
										<span className="text-gray-400 text-sm">Araştırma Görevlisi</span>
									</div>
								</a>
							</a>
						</li>
						...
						<li>
							<button
								...
								<span className="flex-1 ml-3 text-left whitespace-nowrap">Codes</span>
								<svg
									aria-hidden="true"
									className="w-6 h-6"
									fill="currentColor"
